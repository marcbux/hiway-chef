...
default[:hiway][:workflows]                         = "#{node[:hiway][:home]}"
...
default[:hiway][:variantcall][:samtools][:url]      = "http://download.sourceforge.net/project/samtools/samtools/#{node[:hiway][:variantcall][:samtools][:version]}/#{node[:hiway][:variantcall][:samtools][:tarbz2]}"
