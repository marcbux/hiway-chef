...
default[:hiway][:RNASeq][:ref_annotation][:gtf]                = "RNASeq.mm9_ref_annotation.gtf"
default[:hiway][:RNASeq][:ref_annotation][:targz]              = "#{node[:hiway][:RNASeq][:ref_annotation][:gtf]}.tar.gz"
default[:hiway][:RNASeq][:input1][:recplicate1][:url]          = "http://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=dload&run_list=SRR1632911&format=fastq"
default[:hiway][:RNASeq][:input1][:recplicate1][:fastq]        = "GSM1533014_MD_O1_WT_Colon.fastq"
default[:hiway][:RNASeq][:input1][:recplicate2][:url]          = "http://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=dload&run_list=SRR1632912&format=fastq"
default[:hiway][:RNASeq][:input1][:recplicate2][:fastq]        = "GSM1533014_MD_O2_WT_Colon.fastq"
default[:hiway][:RNASeq][:input1][:recplicate3][:url]          = "http://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=dload&run_list=SRR1632913&format=fastq"
default[:hiway][:RNASeq][:input1][:recplicate3][:fastq]        = "GSM1533014_MD_O3_WT_Colon.fastq"
default[:hiway][:RNASeq][:input2][:recplicate1][:url]          = "http://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=dload&run_list=SRR1632942&format=fastq"
default[:hiway][:RNASeq][:input2][:recplicate1][:fastq]        = "GSM1533014_MD_Y1_WT_Colon.fastq"
default[:hiway][:RNASeq][:input2][:recplicate2][:url]          = "http://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=dload&run_list=SRR1632943&format=fastq"
default[:hiway][:RNASeq][:input2][:recplicate2][:fastq]        = "GSM1533014_MD_Y2_WT_Colon.fastq"
default[:hiway][:RNASeq][:input2][:recplicate3][:url]          = "http://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=dload&run_list=SRR1632944&format=fastq"
default[:hiway][:RNASeq][:input2][:recplicate3][:fastq]        = "GSM1533014_MD_Y3_WT_Colon.fastq"
